...
def msg(text):
    if text:
        ...
        board.send_sysex(pyfirmata.STRING_DATA, pyfirmata.util.str_to_two_byte_iter(''))
...
board.send_sysex(pyfirmata.STRING_DATA, pyfirmata.util.str_to_two_byte_iter('Hello!'))

led1 = board.get_pin('d:13:o')
buzzer = board.get_pin('d:8:o')
m1 = board.get_pin('d:4:o')
m2 = board.get_pin('d:5:o')
def stop():
    m1.write(0)
    m2.write(0)
...
model = load_model('F:\Minor Project\Drowsiness detection\models\cnnCat2.h5')
path = os.getcwd()
